...
_MEMORY_LOG_IO_LOCK = threading.RLock()


def _serialized_memory_log_io(method):
    """Serialize process-local access shared by independent portfolio graphs."""
