...
def validate(root: Path = ROOT) -> list[str]:
    ...
    server_compose = require_fragments(
        ...
        (
            ...
            "cap_drop:",
            "name: trading-agents-adapted-data",
            "name: trading-agents-adapted-reports",
            "event-plan-api:",
            "entrypoint: [\"tradingagents-api\"]",
            "name: trading-agents-adapted-api-data",
    ...
    workflow = require_fragments(
        ...
        (
            ...
            "trading-agents-adapted:${{ env.DEPLOY_SHA }}",
    ...
    ci = require_fragments(
        ...
        (
            ...
            "docker run --rm trading-agents-adapted:ci --help",
