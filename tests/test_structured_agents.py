...
from tradingagents.agents.analysts import sentiment_analyst as sentiment_analyst_module
...
class TestSentimentAnalystAgent:
    ...
    def _stub_market_data(self, monkeypatch):
        """Keep structured-output tests deterministic and free of network I/O."""
        monkeypatch.setattr(
            sentiment_analyst_module.get_news,
            "func",
            lambda ticker, start_date, end_date: "<test news data>",
        )
        monkeypatch.setattr(
            sentiment_analyst_module,
            "fetch_stocktwits_messages",
            lambda ticker, limit=30: "<test StockTwits data>",
        )
        monkeypatch.setattr(
            sentiment_analyst_module,
            "fetch_reddit_posts",
            lambda ticker: "<test Reddit data>",
        )
