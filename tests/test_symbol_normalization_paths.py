...
def test_bare_beijing_code_recognizes_only_the_920_segment():
    assert normalize_a_share_symbol("920047") == "920047.BJ"
    assert is_a_share_symbol("920047")
    assert normalize_a_share_symbol("900901") is None
    assert not is_a_share_symbol("900901")
